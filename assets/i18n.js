...
const STRINGS = {
  en: {
    ...
    adminStats: 'Visitors',
    adminStatsIntro: 'Which country people are reading from, and which ancestors they open. No IP addresses, no names, and nothing that follows anyone between visits — deliberately, on a site this small.',
    statsEmpty: 'No visits recorded yet. Numbers appear once people start opening the tree.',
    statsVisits: 'visits, last 30 days',
    statsViews: 'profiles opened',
    statsWeek: 'visits this week',
    statsPerDay: 'Visits per day',
    statsCountries: 'Where people are reading from',
    statsPeople: 'Most-opened profiles',
    statsDevices: 'Phone or computer',
    statsMobile: 'Phone',
    statsDesktop: 'Computer',
  ...
  ur: {
    ...
    adminStats: 'آنے والے',
    adminStatsIntro: 'لوگ کس ملک سے پڑھ رہے ہیں، اور کن بزرگوں کے صفحے کھولتے ہیں۔ نہ کوئی آئی پی ایڈریس، نہ نام، اور نہ کوئی ایسی چیز جو کسی کا پیچھا کرے — اتنی چھوٹی سائٹ پر یہ جان بوجھ کر ایسا رکھا گیا ہے۔',
    statsEmpty: 'ابھی کوئی وزٹ درج نہیں۔ جب لوگ شجرہ کھولنا شروع کریں گے تو اعداد یہاں دکھائی دیں گے۔',
    statsVisits: 'وزٹ، پچھلے ۳۰ دن',
    statsViews: 'صفحات کھولے گئے',
    statsWeek: 'اس ہفتے وزٹ',
    statsPerDay: 'روزانہ وزٹ',
    statsCountries: 'لوگ کہاں سے پڑھ رہے ہیں',
    statsPeople: 'سب سے زیادہ کھولے گئے صفحات',
    statsDevices: 'فون یا کمپیوٹر',
    statsMobile: 'فون',
    statsDesktop: 'کمپیوٹر',
